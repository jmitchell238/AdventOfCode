...
The good news is that they've discovered _project management_! This has given
...
- points at `0` **once**. Times = 1
- The dial is rotated `L30` to point at `52`.
- The dial is rotated `R48` to point at `0`. Times = 2
- The dial is rotated `L5` to point at `95`.
- The dial is rotated `R60` to point at `55`; during this rotation, it
- points at `0` **once**. Times = 3
- The dial is rotated `L55` to point at `0`. Times = 4
- The dial is rotated `L1` to point at `99`.
- The dial is rotated `L99` to point at `0` . Times = 5
- The dial is rotated `R14` to point at `14`.
- The dial is rotated `L82` to point at `32`; during this rotation, it
- points at `0` **once**. Times = 6
