...
public class UtilitiesUses {
  ...
  private static void getOrComputeWithFunctionAddToValueWithoutExistingKeyValuePair() {
    ...
    Integer result =
        Utilities.getOrComputeWithFunctionAddToValue(map, key, k -> k.length(), combiner);
  ...
  private static void getOrAddToMapAddToValueWithoutExistingKeyValuePair() {
    ...
    System.out.println(MAP_STRING + map);
    System.out.printf(
        "\tgetOrAddToMapAddToValue(map, new AbstractMap.SimpleEntry<>(%s, %s), combiner)",
        key, value);

    Integer result =
        Utilities.getOrAddToMapAddToValue(
            map, new AbstractMap.SimpleEntry<>(key, value), Integer::sum);
  ...
  private static void getOrAddToMapAddToValueWithExistingKeyValuePair() {
    ...
    System.out.println(MAP_STRING + map);
    System.out.println(
        NOTE_VALUE_FOR_KEY_STRING + key + "' was added to existing value for key in map");
  }
}
