...
class Day01Tests {
  ...
  void Day01Part1_CalledWithTestInput_ExpectCorrectAnswer() {
    // Arrange
    String day01Part1Input =
        "src/test/java/org/jmitchell238/aoc/aoc2025/day01/input_test_part1.txt";
  ...
  void Day01Part2_CalledWithTestInput_ExpectCorrectAnswer() {
    // Arrange
    String day01Part2Input =
        "src/test/java/org/jmitchell238/aoc/aoc2025/day01/input_test_part2.txt";
